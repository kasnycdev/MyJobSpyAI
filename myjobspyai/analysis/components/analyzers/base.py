...
class LLMMetrics:
    ...
    def __init__(self, provider: BaseProvider, model: Optional[str] = None, config: Optional[Dict[str, Any]] = None):
...
class BaseAnalyzer(Generic[T, P], ABC):
    ...
    def __init__(
        ...
        self.model = model or 'llama3:instruct'
        ...
        # Initialize metrics
        self.metrics = LLMMetrics(provider)
