...
class SkillDetail(BaseModel):
    ...
    level: Optional[str] = Field(
        None,
        description="Proficiency level (e.g., 'Advanced', 'Intermediate', 'Familiar', 'Expert').",
    )
    years_experience: Optional[Any] = Field(  # Changed from Optional[int]
        None,
        description="Approximate years of experience with the skill. LLM may return a range dict.",
    )
