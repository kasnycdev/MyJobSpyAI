...
from myjobspyai.analysis.base import BaseAnalyzer
...
class JobAnalyzer(BaseAnalyzer):
    ...
    def __init__(
        ...
        self.job_extraction_prompt = self._load_prompt_template('job_extraction.prompt')
        self.suitability_analysis_prompt = self._load_prompt_template('suitability_analysis.prompt')
